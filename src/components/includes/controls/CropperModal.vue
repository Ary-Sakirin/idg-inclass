<template>
  <div class="d-flex flex-column align-items-center m-3">
    ...
    <input
      ...
      type="file"
      class="d-none"
      :class="{ 'is-invalid': modelError !== null }"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <Cropper
            ...
            class="cropper"
            :src="cropSrc"
            :stencil-props="{ aspectRatio: props.width / props.height }"
            @change="onCropChange"
          />
        </div>
...
const props = defineProps({
  id: {
    type: String,
    default: () =>
      `CROPPER-MODAL-${Math.random().toString(36).substring(2, 9)}`,
  },
  width: {
    type: Number,
    default: 454,
...
const onImageCropped = () => {
  if (croppedCanvas) {
    ...
    canvas
      .getContext("2d")
      .drawImage(croppedCanvas, 0, 0, props.width, props.height);
