              ...
              <div class="col-12">
                ...
                <div class="row">
                  <div class="form-group col-lg-3">
                    ...
                    <select
                      v-model="studentObj.pob_province_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.pob_province_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in provinces"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select
                      v-model="studentObj.pob_district_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.pob_district_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in pobDistricts"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select
                      v-model="studentObj.pob_commune_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.pob_commune_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in pobCommunes"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
                  ...
                  <div class="form-group col-lg-3">
                    <label>Village</label>
                    <select
                      v-model="studentObj.pob_village_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.pob_village_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in pobVillages"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
              ...
              <div class="col-12">
                ...
                <div class="row">
                  <div class="form-group col-lg-3">
                    <label>Province / Capital</label>
                    <select
                      v-model="studentObj.por_province_id"
                      class="form-control"
                  ...
                  <div class="form-group col-lg-3">
                    <label>District / Municipality / City</label>
                    <select
                      v-model="studentObj.por_district_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.por_district_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in porDistricts"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
                  ...
                  <div class="form-group col-lg-3">
                    <label>Commune / Sangkat</label>
                    <select
                      v-model="studentObj.por_commune_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.por_commune_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in porCommunes"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
                  ...
                  <div class="form-group col-lg-3">
                    <label>Village</label>
                    <select
                      v-model="studentObj.por_village_id"
                      class="form-control"
                      :class="{ 'is-invalid': !!studentErrObj.por_village_id }"
                    >
                      <option :value="null">---none---</option>
                      <option
                        v-for="{ id, name_kh } in porVillages"
                        :key="id"
                        :value="id"
                      >
                        {{ name_kh }}
